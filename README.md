...
- **Metadata filtering** — Optional time-window filtering for retrieval (e.g. ask within a specific timestamp range)
...
| POST | /api/chat/multi/ | Stream a multi-video Gemini AI response (SSE) |
