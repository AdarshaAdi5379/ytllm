  ...
  return (
    <div className="flex justify-end group">
      <div className="max-w-[80%] flex flex-col items-end">
        <div className="bg-indigo-600 text-white rounded-2xl rounded-tr-sm px-3 py-2.5 sm:px-5 sm:py-3 text-sm leading-relaxed break-words overflow-wrap-anywhere">
          {message.content}
        </div>
