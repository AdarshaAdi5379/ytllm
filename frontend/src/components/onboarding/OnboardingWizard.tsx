      ...
      <header className="flex items-center justify-between px-8 py-4 border-b border-slate-100">
        ...
        {step !== 'done' && (
          <button
            ...
            className="text-xs font-medium text-slate-400 hover:text-slate-600 px-3 py-1.5 rounded-lg hover:bg-slate-50 transition-all"
          >
            Skip setup
          </button>
        )}
        ...
        <div className="w-full max-w-sm">
          ...
          {step === 'welcome' && (
            <div className="space-y-6">
              <div>
                <h1 className="text-xl font-semibold text-slate-900">Welcome to KnowledgeOS</h1>
